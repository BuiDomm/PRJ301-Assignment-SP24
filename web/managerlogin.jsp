    ...
    <body>
        <jsp:include page="include/headerlogin.jsp"></jsp:include>
            <div class="main">
                ...
                <form class="form" method="post" action="loginmn">
                    <p id="heading">Log in as admin </p>
                    <div class="field">
                        ...
                        <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="username" value="" required="">
                    </div>
                    <div class="field">
                        <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <a href="loginForm.jsp" style="display: inline-block;float: right; margin-top: -35px;"> Switch Login with Customer</a>
