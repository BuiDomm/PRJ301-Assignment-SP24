...
public class LoginManager extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ManagerDAO mnd = new ManagerDAO();
        if (mnd.login(user, pass) != null && mnd.login(user, pass) instanceof Manager) {
            session.setAttribute("manageraccount", mnd.login(user, pass));
            response.sendRedirect("loader_2.jsp");
        } else {
