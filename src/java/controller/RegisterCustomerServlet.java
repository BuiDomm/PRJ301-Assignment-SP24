...
public class RegisterCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String surfname = request.getParameter("lastname");
        String username = request.getParameter("username");
        String password = request.getParameter("password");
        String email = request.getParameter("email");
        String phone = request.getParameter("phone");
        if (username == null || password == null || firstName == null || surfname == null || email == null || phone == null) {
            request.setAttribute("erorr", "Missing information. Please fill all information.");
